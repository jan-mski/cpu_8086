...
InstructionSpec INSTRUCTION_SPECS[256] = {
    ...
    /* 10001100 */ {},
    /* 10001101 */ {MNEMONIC_LEA, {W_FORCED(1), {MOD, 1, 6}, {REG, 1, 3}, {RM, 1, 0}, {DISP}}, {REGISTER, REG_OR_MEM_ADDR}},
    /* 10001110 */ {},
    ...
    /* 10011010 */ {},
    /* 10011011 */ {},
    /* 10011100 */ {MNEMONIC_PUSHF},
    /* 10011101 */ {MNEMONIC_POPF},
    /* 10011110 */ {MNEMONIC_SAHF},
    /* 10011111 */ {MNEMONIC_LAHF},
    ...
    /* 11000010 */ {},
    /* 11000011 */ {},
    /* 11000100 */ {MNEMONIC_LES, {W_FORCED(1), {MOD, 1, 6}, {REG, 1, 3}, {RM, 1, 0}, {DISP}}, {REGISTER, REG_OR_MEM_ADDR}},
    /* 11000101 */ {MNEMONIC_LDS, {W_FORCED(1), {MOD, 1, 6}, {REG, 1, 3}, {RM, 1, 0}, {DISP}}, {REGISTER, REG_OR_MEM_ADDR}},
